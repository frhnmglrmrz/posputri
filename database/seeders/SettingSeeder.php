...
class SettingSeeder extends Seeder
{
    ...
    {
        $settings = [
            ['key' => 'store_name', 'value' => 'POS Putri Outlet 01', 'group' => 'store'],
            ...
            ['key' => 'receipt_header', 'value' => 'POS PUTRI RETAIL & F&B', 'group' => 'receipt'],
            ['key' => 'receipt_footer', 'value' => 'Terima kasih atas kunjungan Anda. Simpan struk ini sebagai bukti pembayaran sah.', 'group' => 'receipt'],
